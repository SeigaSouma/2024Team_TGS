...
void CCameraTrigger_Pass::waiting()
{
	...
	CSerifEffect::Create(MyLib::Vector3(460.0f, 520.0f, 900.0f), MyLib::Vector3(0.0f,0.0f,0.0f), 70);
...
void CCameraTrigger_Pass::carry()
{
	...
	CSerifEffect::Create(MyLib::Vector3(540.0f, 520.0f, 900.0f), MyLib::Vector3(0.0f,0.0f,D3DX_PI), 70);
