...
// 生成処理
//==========================================================================
CStoneWall* CStoneWall::Create(const std::string& file)
{
	// メモリの確保
...
// 頂点座標
//==========================================================================
void CStoneWall::SetVtxPosition()
{
	// 計算用変数
...
// ロード処理
//==========================================================================
HRESULT CStoneWall::Load(const std::string& file)
{
	// ファイルを開く
...
// 当たり判定ボックス取得
//==========================================================================
CCollisionLine_Box* CStoneWall::GetCollisionLineBox(int idx)
{
