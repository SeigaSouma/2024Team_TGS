...
namespace
{
	...
	const float DEFAULT_INTERVAL_LEAFSPAWN_TITLE = 0.6f;		// デフォの降る葉生成間隔
}
...
void CSpawn_Leaf_Title::TriggerSpawn()
{
	// タイマー関連リセット
	m_fSpawnTimer = 0.0f;
	m_fSpawnInterval = DEFAULT_INTERVAL_LEAFSPAWN_TITLE + UtilFunc::Transformation::Random(-40, 40) * 0.01f;
